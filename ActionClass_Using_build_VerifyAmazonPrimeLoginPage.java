...
public class ActionClass_using_build_VerifyAmazonPrimeLoginPage {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		act.moveToElement(driver.findElement(By.xpath("//span[text()='Departments']")))
		//take mouse cursor on Amazon music inside Departments
		.moveToElement(driver.findElement(By.xpath("//span[text()='Amazon Music']"))).build().perform();
